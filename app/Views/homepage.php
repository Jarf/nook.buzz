<div class="homepagecontainer">
	<div class="homepage">
		...
		<p>
			...
			If you wish to view another month to see what is coming up you can click the arrows besides the displayed month's name to go to the next or previous month.<br/>
			You can now also find a button to toggle between north/south hemisphere on the fish/insect pages.
		</p>
		<h4>I have feedback!</h4>
		<p>
			Drop me a message on <a target="_blank" href="https://twitter.com/jarfino">twitter</a> and I'll do what I can.
		</p>
		<h4>My thirst for knowledge is unquenched</h4>
		<p>
			Still here?<br/>
			You can find the github repository <a target="_blank" href="https://github.com/Jarf/nook.buzz">here</a>.
		</p>
	</div>
</div>